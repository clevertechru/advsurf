  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved import as @import" do
        ...
        post :create, {:import => { "file_name" => "invalid value" }}, valid_session
        assigns(:import).should be_a_new(Import)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested import" do
        ...
        Import.any_instance.should_receive(:update_attributes).with({ "file_name" => "MyString" })
        put :update, {:id => import.to_param, :import => { "file_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the import as @import" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Import.any_instance.stub(:save).and_return(false)
        put :update, {:id => import.to_param, :import => { "file_name" => "invalid value" }}, valid_session
        assigns(:import).should eq(import)
      end
